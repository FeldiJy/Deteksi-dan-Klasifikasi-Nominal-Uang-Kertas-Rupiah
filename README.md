...
3. Jalankan perintah berikut: `keytool -list -v -keystore debug.keystore -alias androiddebugkey -storepass android -keypass android`
4. Setelah perintah dijalankan, sistem akan menampilkan SHA-1 dan SHA-256
5. SHA tersebut kemudian ditambahkan ke Firebase Console oleh pemilik project
